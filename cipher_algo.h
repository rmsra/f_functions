...
namespace saue_mm
{
    class cipher_algo_Rijndael: public cipher_algo
    {
        private:
            ...
            cipher_algo_Rijndael(/* args */);

            /* Round key addition function */
            inline void KeyAdd(uint8_t state[4][4], uint8_t roundKeys[11][4][4], int round)
            {
                int i, j;
            ...
            inline int ByteSub(uint8_t state[4][4])
            {
                int i, j;
            ...
            inline void ShiftRow(uint8_t state[4][4])
            {
                uint8_t temp;
            ...
            inline void MixColumn(uint8_t state[4][4])
            {
        ...
        public:
            ...
            static cipher_algo_Rijndael* get_instance();
